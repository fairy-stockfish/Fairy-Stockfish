...
typedef Stats<int16_t, 5000, COLOR_NB, SQUARE_NB> DuckHistory;
...
public:
  ...
  MovePicker(const Position&, Move, Value, const DuckHistory*, const CapturePieceToHistory*);
