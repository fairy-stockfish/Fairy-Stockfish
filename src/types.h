...
enum RiderType : int {
  ...
  RIDER_JUMPER_DABBABA = 1 << 14,
  RIDER_JUMPER_ALFIL = 1 << 15,
  ...
  JUMPERS = RIDER_JUMPER_DABBABA | RIDER_JUMPER_ALFIL,
  ASYMMETRICAL_RIDERS =  RIDER_HORSE | RIDER_JANGGI_ELEPHANT
                       | RIDER_GRASSHOPPER_H | RIDER_GRASSHOPPER_V | RIDER_GRASSHOPPER_D,
  NON_SLIDING_RIDERS = HOPPING_RIDERS | LAME_LEAPERS | RIDER_NIGHTRIDER | JUMPERS,
};
