...
extern "C" PyObject* pyffish_version(PyObject* self) { return Py_BuildValue("(iii)", 0, 0, 90); }
...
extern "C" PyObject* pyffish_capturesToHand(PyObject* self, PyObject* args) {
    ...
    return Py_BuildValue(
      "O", variants.find(std::string(variant))->second->capturesToHand ? Py_True : Py_False);
}
...
extern "C" PyObject* pyffish_validateFen(PyObject* self, PyObject* args) {
    ...
    return Py_BuildValue(
      "i",
      FEN::validate_fen(std::string(fen), variants.find(std::string(variant))->second, chess960));
}
...
extern "C" PyObject* pyffish_getFogFEN(PyObject* self, PyObject* args) {
    ...
    return Py_BuildValue("s",
                         pos.fen(sfen, showPromoted, countStarted, "-", pos.fog_area()).c_str());
}
...
static PyMethodDef PyFFishMethods[] = {
  ...
  {"is_capture", (PyCFunction) pyffish_isCapture, METH_VARARGS,
   "Get whether given move is a capture from given FEN and movelist."},
  {"piece_to_partner", (PyCFunction) pyffish_pieceToPartner, METH_VARARGS,
   "Get unpromoted captured piece from given FEN and movelist."},
  ...
  {"get_fog_fen", (PyCFunction) pyffish_getFogFEN, METH_VARARGS,
   "Get Fog of War FEN from given FEN."},
  {NULL, NULL, 0, NULL},  // sentinel
};

static PyModuleDef pyffishmodule = {
  PyModuleDef_HEAD_INIT, "_pyffish", "Fairy-Stockfish extension module.", -1, PyFFishMethods,
};
...
PyMODINIT_FUNC PyInit__pyffish() {
    ...
    PyModule_AddObject(module, "FEN_INVALID_PROMOTED_PIECE",
                       PyLong_FromLong(FEN::FEN_INVALID_PROMOTED_PIECE));
