...
def get_san(variant: str, fen: str, move: str, chess960: bool = False, notation: int = NOTATION_DEFAULT, lastMoveUci: str | None = None) -> str: ...
def get_san_moves(variant: str, fen: str, movelist: list[str], chess960: bool = False, notation: int = NOTATION_DEFAULT, lastMoveUci: str | None = None) -> list[str]: ...
